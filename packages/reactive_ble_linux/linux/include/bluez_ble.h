...
BleNotifRing* bluez_ble_ring_create(uint32_t capacity);  // power-of-two
...
bool          bluez_ble_ring_pop(BleNotifRing* ring, uint8_t** out_data,
                                  uint32_t* out_len,
...
void        bluez_ble_free(void* ptr);  // wraps free()
